<x-app-layout title="User Management" header="User Management">
    @can('user_create')
        <div class="row">
            <div class="col-sm-4">
                <a href="{{ route('user.create') }}" class="btn btn-blue waves-effect waves-light mb-3"><i
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="header-title mb-3">List of users</h4>
                                    ...
                                    @if ($item->id != 1)
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                @can('user_show')
                                                    <form action="{{ route('user.show', $item) }}" method="get">
                                                        @csrf
                                                ...
                                                @endcan
                                                @can('user_edit')
                                                    <form action="{{ route('user.edit', $item) }}" method="get">
                                                        @csrf
                                                        <button type="submit" class="dropdown-item"><i
